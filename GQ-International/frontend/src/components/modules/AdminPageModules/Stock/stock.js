...
export default class Stock extends Component {
    ...
    render() {
        return (
            <div className='card' style={{borderRadius:'30px',marginTop:'5px',width:'100%',alignItems:'center',marginLeft:'20px'}} >
            <div className="container">
                ...
                <button className="btn-grad9" style={{width:'200px'}}>
            ...
            &nbsp;&nbsp;&nbsp;
            <button className="btn-grad9" style={{width:'160px'}}>
            ...
            <button className="btn-grad9" style={{width:'160px'}}>
                    ...
                    <input
                        ...
                        style={{width:'250px',marginLeft:'600px',marginTop:'-60px'}}>
                    </input>
                </div>
