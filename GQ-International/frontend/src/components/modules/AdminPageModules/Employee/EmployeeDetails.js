...
class EmployeeDetails extends Component {
    ...
    render() {
        ...
        return (
            ...
            <div style={{marginTop:'20px',marginLeft:'50px',textAlign:'center', marginRight:'200px'}}>&nbsp;&nbsp;&nbsp;
                ...
                <button className='btn-grad' style={{margin:'20px',marginLeft:'400px',float:'right'}}> <a href='/allEmp' style={{textDecoration:'none',textAlign:'center',color:'white'}}> Back To Dashboard</a></button>
            </div>
        );
    }
}
