...
class AttendanceDetails extends Component {
    ...
    render() {
        ...
        return (
            <div className="card" style={{marginTop:'20px', alignItems:'center',width:'70%',height:'100%',display:'flex'}}>
                ...
                <button className='btn-grad' style={{margin:'20px',marginLeft:'400px',float:'right'}}> <a href='/viewAttendance' style={{textDecoration:'none',textAlign:'center',color:'white'}}> Back To Dashboard</a></button>
            </div>
        );
    }
}
