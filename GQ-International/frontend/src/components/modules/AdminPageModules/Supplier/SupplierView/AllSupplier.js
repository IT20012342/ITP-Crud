                ...
                <tbody>
                    ...
                    {suppliers.map(suppliers =>
                        ...
                        <tr>
                            ...
                            <td><center>
                                <Button variant="outline-success" onClick={e => { setUpdate(true); selectUser(suppliers._id); }}>
                                    <i class="fas fa-edit"></i>
                                </Button>
                                <Button variant="outline-danger" onClick={() => { deleteSup(suppliers._id); setShow(true); }}>
