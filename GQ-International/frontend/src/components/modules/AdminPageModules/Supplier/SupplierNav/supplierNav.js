...
const supplierNav = () => {
    return (
        <Nav justify variant="tabs" defaultActiveKey="/home" className='navSupplier'>
            <Nav.Item>
                <Nav.Link href="/supplier"  className='navitemsSupplier' active><span className='supplierNavbar'>Supplier Information</span></Nav.Link>
            </Nav.Item >
            ...
            <Nav.Item>
                <Nav.Link eventKey="disabled" disabled className='navitemsSupplier'>
